...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, description: string, name: string, price: number, images: Array<{ url: string }> } | null }> } | null };
